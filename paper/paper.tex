...
% TODO: Double-check that logn is correct.
...
% TODO center by adjusting margins around table
\begin{table}
\begin{center}
...
We designed this scenario to simulate an average level of churn over 16 days. The difference in data sent between the instance with churn and the one without is 14.27 GB. This means, on average, each peer sent an additional 146.12 MB of data in the presence of churn. In other words, with our system, the average peer can expect to create an additional replica every $\dfrac{16 \text{ days}}{146.12 \text{ MB}} \times 100 \text{ MB per replica} = 10.95 \text{ days}$.
...
% TODO: I might just be guessing on the password hash as a key part. Does this actually work?
...
\bibitem{onedriveusers} http://blog.onedrive.com/over-250m-people-using-skydrive/
...
\bibitem{kademliaDHT} P. Maymounkov, D. Mazi\`eres, Kademlia: A Peer-to-peer Information System Based on the XOR Metric, IPTPS '01 Revised Papers from the First International Workshop on Peer-to-Peer Systems (2002), 53-65.
