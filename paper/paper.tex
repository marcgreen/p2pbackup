...
% TODO: Is it actually called SZTAKI Cloud? I've looked through my emails, and Mihaly never calls it exactly that. If we could put as much as we want, it might be nice to put a screenshot of the web interface.
...
Section \ref{sec:EffectsofChurn} explained that, in the presence of an average amount of churn, 
...
% TODO explain what NAT is why and it makes P2P hard?
