...
As the capacity and performance of hard drives increase over time, people are able to store data in greater volumes. With this increase in capacity, there is a greater need for data to be backed up, in case one's data becomes irrecoverable. This can happen if one's computer crashes, the hard drive fails, or the computer is lost or stolen.
