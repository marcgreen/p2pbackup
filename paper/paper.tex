...
% TODO when rm command is added, mention the required use of it when a user wants to delete a file so that our program knows to delete this hardlink
...
% TODO discuss "our implemented challenge mechanism" in metadata controller of btbackup design chapter, and remind reader of it here
